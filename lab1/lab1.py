...
# you need to.
sibling_xy = 'sibling (?x) (?y)'
sibling_yx = 'sibling (?y) (?x)'
child_xy = 'child (?x) (?y)'
...
# family_rules.
family_rules = [ IF(AND(parent_yx, 'male (?y)'), THEN('father (?y) (?x)')),
                    ...
                    IF(AND(parent_yx, 'parent (?y) (?z)','female (?x)', NOT('same-person (?x) (?z)')), THEN('sister (?x) (?z)')),
                    IF(AND(parent_yx, 'parent (?y) (?z)', 'male (?x)', NOT('same-person (?x) (?z)')), THEN('brother (?x) (?z)')),
                    IF(AND(parent_yx, 'parent (?x) (?z)', 'parent (?y) (?a)', 'parent (?a) (?b)', NOT('same-person (?z) (?b)'), NOT('same-person (?x) (?a)')), THEN('cousin (?z) (?b)')),
                    IF(AND(parent_yx, 'parent (?x) (?z)', 'parent (?y) (?a)', 'parent (?a) (?b)', NOT('same-person (?z) (?b)'), NOT('same-person (?x) (?a)')), THEN('cousin (?b) (?z)')),]
                                       # fill me in
